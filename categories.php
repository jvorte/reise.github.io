...
<!-- <img src="images/travel2.png" alt="" srcset=""> -->
...
<section class="trip-menu">
        <div class="container1">
            ...
            while ( $row= $stmt->fetch()) 
            {
               ...
               ?>
               <a href="<?php echo SITEURL;?>categories-zubehor.php?artikelGruppe=<?php echo $id;?>">

              <div class="trip-menu-box1">
             ...
             if ($image_name=="") 
                ...
                {
                ?>
                <img src="<?php echo SITEURL;?>images/category/<?php echo $image_name; ?>" alt="trip" class="img-responsive img-curve" >
