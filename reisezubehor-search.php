...
<div id="rect">  
        ...
        //get th source keyword 
        $search = $_POST['search'];
        
        ?>
             -->
            <h2>Suchergebnisse<a href="#" class="text-white"><?php  echo $search;?>'</a></h2>
    ...
    <section class="trip-menu">
        <div class="container">
            ...
            <?php    
             //sql query to base on search keyword
            $sql = "SELECT * FROM artikel WHERE artikelName LIKE '%$search%' OR artikelBeschreibung LIKE '%$search%'";
